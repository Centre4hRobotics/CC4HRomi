...
/**
 * Class to access a servo motor. See instructions for how to connect to your Romi.
 */
class ServoMotor
{
public:
    /**
     * Construct the ServoMotor with a given pin. For our configuration of the Romi
     * this will almost always be pin #11. 
     * 
